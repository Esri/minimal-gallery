define(["require", "exports", "esri/widgets/support/widget", "./views/AppView", "./views/ViewComposites"], function (require, exports, widget_1, AppView_1, ViewComposites_1) {
    ...
    exports.default = function (props) {
        ...
        var viewBackgroundColor = props.bgColor ? props.bgColor : "ffffff";
        ...
        return {
            render: function () {
                return (widget_1.jsxFactory.createElement("div", { id: "view-container", key: "view-container", classes: containerClasses, style: "background-color: " + convertHex(viewBackgroundColor, 85) },
                    widget_1.jsxFactory.createElement("div", { id: "map-container" },
                        view.render(),
                        widget_1.jsxFactory.createElement("button", { class: "btn btn-clear view-exit-button clickable", onclick: handleExitClick, title: props.i18n.ui.close },
                            widget_1.jsxFactory.createElement("span", { class: "icon-ui-close view-exit-icon" })))));
            }
        };
...
//# sourceMappingURL=MaxViewer.js.map