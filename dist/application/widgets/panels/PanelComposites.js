...
define(["require", "exports", "./PanelBase"], function (require, exports, PanelBase_1) {
    ...
    exports.MapPanel = function (props) { return (PanelBase_1.default(__assign({}, props, { captionColor: props.config.mapCaptionColor, extItem: props.i18n.ui.itemExtTip, extLink: "http://jsapi.maps.arcgis.com/home/item.html?id=" + props.item.id, extTitle: props.i18n.ui.mapExtTip, itemClickHandler: function () {
            props.itemClickHandler(props.item.id, "webmap");
        }, maxLink: "viewApp.html?itemId=" + props.item.id + "&type=webmap" }))); };
    exports.ScenePanel = function (props) { return (PanelBase_1.default(__assign({}, props, { captionColor: props.config.sceneCaptionColor, extItem: props.i18n.ui.itemExtTip, extLink: "http://jsapi.maps.arcgis.com/home/item.html?id=" + props.item.id, extTitle: props.i18n.ui.sceneExtTip, itemClickHandler: function () {
